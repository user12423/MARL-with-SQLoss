...
def corrections_func(mainPN, batch_size, trace_length,
    ...
    -----
        ...
        cube: tf.Varialbe or None (default: None)
            If provided, should be constructed via `sqloss.utils.make_cube`.
    ...
    net_v0 = v_0_pi_0__current + 0.5*v_0_pi_0__past #+ v0_l2_loss
    net_v1 = v_1_pi_1__current + 0.5*v_1_pi_1__past #+ v1_l2_loss
    v_0_grad_theta_0 = flatgrad(net_v0, mainPN[0].parameters, clip_norm=clip_norm_val)
    v_1_grad_theta_1 = flatgrad(net_v1, mainPN[1].parameters, clip_norm=clip_norm_val)
