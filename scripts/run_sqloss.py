...
from sqloss import logger

from sqloss.envs import *
...
def main(exp_name, num_episodes, trace_length, exact, pseudo, grid_size,
    ...
    if exact:
        ...
        def run(env):
            from sqloss.train_exact import train
            train(env,
        ...
        def run(env):
            from sqloss.train_pg import train
            train(env,
                  num_episodes=num_episodes,
                  trace_length=trace_length,
        ...
        def run(env):
            from sqloss.train_cg import train
            train(env,
                  num_episodes=num_episodes,
                  trace_length=trace_length,
                  batch_size=batch_size,
